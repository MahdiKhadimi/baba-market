                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" value="{{ old('title') }}"
                                        class="form-control @error('title') is-ivalid @enderror" placeholder="Title">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slug"
                                        class="form-control @error('parent') is-ivalid @enderror" id="slug"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select name="category" class="form-select @error('category') is-ivalid @enderror">
                        ...
                        @foreach ($cats_paginate as $key => $cat)
                            <tr data-id="5" style="cursor: pointer;">
                                ...
                                <td class="text-center">
                                    <a href="{{ route('show.edit.category', $cat->id) }}"
