                    ...
                    <tbody>
                        ...
                        @foreach ($colors as $key => $color)
                            <tr data-id="5" style="cursor: pointer;">
                                ...
                                <td data-field="color">
                                    <img class="avatar-sm rounded-circle" style="background-color:{{ $color->code }}"
                                        width="20" height="20" alt="">

                                </td>
                                <td class="text-center">
                                    <a href="{{ route('show.edit.color', $color->id) }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" value="{{ old('name') }}"
                                        class="form-control @error('name') is-ivalid @enderror" placeholder="color name">
