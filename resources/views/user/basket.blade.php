                            ...
                            <tr>
                                ...
                                <td>
                                    @if (!is_null($basket->color_id))
                                        <div class="rounded-3"
                                            style="width: 20px ; height: 20px; background-color:{{ $basket->color->code }} ">
                                        </div>
                                    @endif
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    @if (!is_null($basket->product->on_sale))
                                        ...
                                        @endif
                                        <span class="bold badge badge-soft-info"> {{ $basket->product->started_at }}</span>
                                        to
                                ...
                                <td>
                                    <img class="avatar-sm"
                                        src="{{ asset(config('shop.productCoverPath') . $basket->product->image) }}"
                                        alt="">
                                </td>
                                <td>
                    ...
                    @isset($coupon)
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>@money(DISCOUNT($total_without_on_sale, $coupon['percent']) + $total_with_on_sale)
                                </td>
                            </tr>
                        </table>
                    @endisset
